...
- transfer function: a `transferToken` function specifically for transferring tokens
- Burning: a `burn` function for users to burn their own tokens, adding a common and expected feature for ERC-20 tokens.
